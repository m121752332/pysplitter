...
# Form implementation generated from reading ui file 'pyspiltter.ui'
#
...
class Ui_pysplitter(object):
    def setupUi(self, pysplitter):
        ...
        self.pipediter = QtWidgets.QTextBrowser(self.groupBox_2)
        self.pipediter.setObjectName("pipediter")
        self.horizontalLayout_2.addWidget(self.pipediter)
        ...
        self.sqlediter = QtWidgets.QTextBrowser(self.groupBox_3)
        self.sqlediter.setObjectName("sqlediter")
        self.horizontalLayout.addWidget(self.sqlediter)
        self.gridLayout.addWidget(self.splitter, 0, 0, 1, 1)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/pic/icon/group.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/pic/icon/start.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.datatable.setDragDropMode(QtWidgets.QAbstractItemView.DragDrop)
        ...
        self.datatable.horizontalHeader().setDefaultSectionSize(140)
        ...
        self.excel.setGeometry(QtCore.QRect(10, 10, 80, 23))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/pic/icon/paste.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/pic/icon/lingua.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lang.setIcon(icon4)
        self.lang.setObjectName("lang")
        self.editcopy = QtWidgets.QAction(pysplitter)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/pic/icon/copy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap(":/pic/icon/copy.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.editcopy.setIcon(icon5)
        ...
        self.editcut.setIcon(icon6)
        self.editcut.setObjectName("editcut")
        self.editpaste = QtWidgets.QAction(pysplitter)
        self.editpaste.setIcon(icon3)
        self.editpaste.setObjectName("editpaste")
        self.insert = QtWidgets.QAction(pysplitter)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/pic/icon/new.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.insert.setIcon(icon7)
        self.insert.setObjectName("insert")
        self.help2 = QtWidgets.QAction(pysplitter)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/pic/icon/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.help2.setIcon(icon8)
        ...
        self.exit2 = QtWidgets.QAction(pysplitter)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/pic/icon/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.exit2.setIcon(icon11)
        self.exit2.setObjectName("exit2")
        self.modify = QtWidgets.QAction(pysplitter)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/pic/icon/pen.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.modify.setIcon(icon12)
        self.modify.setObjectName("modify")
        self.delete_2 = QtWidgets.QAction(pysplitter)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/pic/icon/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.delete_2.setIcon(icon13)
        self.delete_2.setObjectName("delete_2")
        self.reproduce = QtWidgets.QAction(pysplitter)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/pic/icon/copy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.reproduce.setIcon(icon14)
        self.reproduce.setObjectName("reproduce")
        self.invalid = QtWidgets.QAction(pysplitter)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/pic/icon/garbage.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.invalid.setIcon(icon15)
        self.invalid.setObjectName("invalid")
        self.detail = QtWidgets.QAction(pysplitter)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/pic/icon/prop.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.detail.setIcon(icon16)
        self.detail.setObjectName("detail")
        self.printer = QtWidgets.QAction(pysplitter)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/pic/icon/printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.printer.setIcon(icon17)
        self.printer.setObjectName("printer")
        self.exporttoexcel = QtWidgets.QAction(pysplitter)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/pic/icon/export.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.exporttoexcel.setIcon(icon18)
        ...
        self.query.setIcon(icon19)
        self.query.setObjectName("query")
        self.qbe_select = QtWidgets.QAction(pysplitter)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/pic/icon/file_q.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon20.addPixmap(QtGui.QPixmap(":/pic/icon/filefind.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.qbe_select.setIcon(icon20)
        self.qbe_select.setObjectName("qbe_select")
        self.qbe_save = QtWidgets.QAction(pysplitter)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/pic/icon/file_w.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.qbe_save.setIcon(icon21)
        self.qbe_save.setObjectName("qbe_save")
        self.first = QtWidgets.QAction(pysplitter)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/pic/icon/gobegin.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.first.setIcon(icon22)
        self.first.setObjectName("first")
        self.previous = QtWidgets.QAction(pysplitter)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/pic/icon/prev.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.previous.setIcon(icon23)
        self.previous.setObjectName("previous")
        self.jump = QtWidgets.QAction(pysplitter)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/pic/icon/balloon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.jump.setIcon(icon24)
        self.jump.setObjectName("jump")
        self.next = QtWidgets.QAction(pysplitter)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/pic/icon/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.next.setIcon(icon25)
        self.next.setObjectName("next")
        self.last = QtWidgets.QAction(pysplitter)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/pic/icon/goend.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.last.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/pic/icon/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.help.setIcon(icon27)
        self.help.setObjectName("help")
        self.exit = QtWidgets.QAction(pysplitter)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/pic/icon/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.exit.setIcon(icon28)
    ...
    def retranslateUi(self, pysplitter):
        ...
        self.help2.setText(_translate("pysplitter", "說明"))
        self.help2.setShortcut(_translate("pysplitter", "Ctrl+H"))
        ...
        self.exit2.setText(_translate("pysplitter", "離開"))
        self.exit2.setShortcut(_translate("pysplitter", "Esc"))
        ...
        self.exit.setShortcut(_translate("pysplitter", "Esc"))
import pyspiltter_rc
